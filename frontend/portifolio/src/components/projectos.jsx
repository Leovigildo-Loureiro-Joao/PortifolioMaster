  ...
  const [projectos] = useState([
    {
      ...
      desc:
        "Uma plataforma para cursos online, focada na experiência do aluno e no acompanhamento de progresso. Focado no ensino de Angola, levando o aprendizado a cada canto de forma simples e divertida.",
      obje:
        "Permitir um ensino adequado em Angola através de cursos online pagos ou gratuitos.",
      lance: "Indeterminado",
      abertura: "--/--/--",
    ...
    },
    {
      ...
      desc:
        "App móvel com interface fluida, focado na aprendizagem adaptativa. O utilizador pode criar metas e acompanhar o progresso de estudo.",
      obje: "Tornar o estudo móvel mais prático e intuitivo.",
      lance: "Em desenvolvimento",
      abertura: "12/10/2025",
      tecno: ["react", "xd"],
    },
    {
      ...
      desc:
        "Permite partilhar snippets, projetos e colaborar em tempo real com outros devs. Interface moderna e responsiva.",
      obje: "Fomentar a partilha e colaboração entre programadores.",
      lance: "Q1 2026",
      abertura: "--/--/--",
      tecno: ["spring", "react"],
    },
              ...
              {filteredProjects.map((value, key) => (
                ...
                >
                  ...
                  <div className="p-5 text-center">
                    ...
                    <p className="text-sm text-gray-600 mt-2">{value.mini_desc}</p>
                  </div>
     ...
     <AnimatePresence>
        {selected && (
            ...
            >
                ...
                <video
                    src={selected.video || selected.img2 || selected.img}
                ...
                <div className="flex gap-4">
                    {selected.tecno.map((v, k) => (
                    <img key={k} className="w-[35px]" src={TecnoFerra(v)} />
                    ))}
                </div>
                </div>
            </motion.div>
